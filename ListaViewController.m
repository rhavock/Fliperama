...
-(void)viewDidLoad{
    ...
    menu = [[KYGooeyMenu alloc]initWithOrigin:CGPointMake(CGRectGetMidX(self.viewMenu.frame), self.viewMenu.frame.origin.y+60) andDiameter:50.0f andDelegate:self themeColor:[UIColor colorWithRed:51/255.0 green:204/255.0 blue:255/255.0 alpha:1.5f ]];
    menu.radius = 80/4;
